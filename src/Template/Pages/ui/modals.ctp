...
<!-- SweetAlert2 -->
<?php echo $this->Html->script('AdminLTE./plugins/sweetalert2/sweetalert2.min'); ?>
<!-- Toastr -->
<?php echo $this->Html->script('AdminLTE./plugins/toastr/toastr.min'); ?>
...
<?php $this->start('css');?>
<?php echo $this->Html->css('AdminLTE./plugins/toastr/toastr.min'); ?>
<?php $this->end();?>