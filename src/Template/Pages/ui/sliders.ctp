...
<!-- Ion Slider -->
<?php echo $this->Html->script('AdminLTE./plugins/ion-rangeslider/js/ion.rangeSlider.min'); ?>
<!-- Bootstrap slider -->
<?php echo $this->Html->script('AdminLTE./plugins/bootstrap-slider/bootstrap-slider.min'); ?>
<script>
    $(function () {
        /* BOOTSTRAP SLIDER */
...
<?php $this->start('css');?>
<?php echo $this->Html->css('AdminLTE./plugins/ion-rangeslider/css/ion.rangeSlider.min'); ?>
<?php echo $this->Html->css('AdminLTE./plugins/bootstrap-slider/css/bootstrap-slider.min'); ?>
<?php $this->end();?>