...
<!-- PAGE PLUGINS -->
<!-- Ekko Lightbox -->
<?php echo $this->Html->script('AdminLTE./plugins/ekko-lightbox/ekko-lightbox.min'); ?>
<!-- Filterizr-->
<?php echo $this->Html->script('AdminLTE./plugins/filterizr/jquery.filterizr.min'); ?>
...
<?php $this->start('css');?>
<?php echo $this->Html->css('AdminLTE./plugins/ekko-lightbox/ekko-lightbox'); ?>
<?php $this->end();?>
