                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <?php echo $this->Html->image('AdminLTE.user1-128x128.jpg', ['alt' => 'User Avatar', 'class' => 'img-size-50 mr-3 img-circle']); ?>
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Brad Diesel
                                        <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <?php echo $this->Html->image('AdminLTE.user8-128x128.jpg', ['alt' => 'User Avatar', 'class' => 'img-size-50 img-circle mr-3']); ?>
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
                                        <span class="float-right text-sm text-muted"><i class="fas fa-star"></i></span>
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <?php echo $this->Html->image('AdminLTE.user3-128x128.jpg', ['alt' => 'User Avatar', 'class' => 'img-size-50 img-circle mr-3']); ?>
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
                                        <span class="float-right text-sm text-warning"><i class="fas fa-star"></i></span>
            ...
            <?php if (!empty($user_menu)) : ?>
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <?php echo $this->Html->image('AdminLTE.user2-160x160.jpg', ['alt' => 'User Image', 'class' => 'user-image img-circle elevation-2']); ?>
                        <span class="d-none d-md-inline">Alexander Pierce</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <?php echo $this->Html->image('AdminLTE.user2-160x160.jpg', ['alt' => 'User Image', 'class' => 'img-circle elevation-2']); ?>
